...
jQuery(document).ready(function() {
	...
	*/
	...
	$('nav a').on('click', function(e) {
		...
		else if(element_class == 'menu-zz')  { var clonedEvent = new MouseEvent('click', e); event.target.dispatchEvent(clonedEvent);}
            //window.open('about.html','_blank'); }
        else if(element_class == 'menu-alt-contact')  {document.location.href = "mailto:bioengineering@berkeley.edu?Subject=I'm%20interested!"; }
    ...
    */
    ...
    $('.about-container').backstretch("assets/img/backgrounds/5.jpg");
    ...
    */
    //var now = new Date();
    var arr = new Date("August 1, 2014 12:00:00")
...
*/
    $(function(){
        $("#mydiv").typed({
            strings: ["We are coming, soon.", "We are nearly done.", "We are a work in progress.", "We are still working.", "We are building something amazing."],
